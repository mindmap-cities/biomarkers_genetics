...
opal.assign.table.tibble(erasmus_opal, 'Tra3_4_Baseline','CLSA_1.Tra3_4_Baseline', variables =list())

CLSA_tra0 <- opal.execute(erasmus_opal,'Tra3_4_Baseline')

opal.assign.table.tibble(erasmus_opal, 'Tra_FU1','CLSA_1.Tra_FU1',  variables=list())
...
```{r, echo=FALSE}
bio_CLSA_TRA_0 <- data.frame(id = CLSA_tra0$id)
bio_CLSA_TRA_1 <- data.frame(id = CLSA_tra1$id)
```
