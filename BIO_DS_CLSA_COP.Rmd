...
**Harmonization comment**: In this study, values "less than 0.1 - exact value undetermined" are coded as null.    
**R script**:  
```{r, echo=TRUE}
...
**Harmonization status**:  complete  
**Harmonization comment**:  In this study, values that are "greater than 100 - exact value undetermined" or "less than 0.3 - exact value undetermined" are coded as null.  
**R script**:  
```{r, echo=TRUE}
...
**Harmonization status**:  complete  
**Harmonization comment**:  In this study, values "less than 5 - exact value undetermined" are coded as null.   
**R script**:  
```{r, echo=TRUE}
...
**Category coding**: 
**Harmonization status**:  complete  
**Harmonization comment**:  In this study, values "greater than 350 - exact value undetermined" and values "less than 8 - exact value undetermined" are coded as null.  
**R script**:  
```{r, echo=TRUE}
