...
#opal.assign.table.tibble(erasmus_opal, 'table','GLOBE.table', variables =list())

#GLOBE_table <- opal.execute(erasmus_opal,'table')

```
## Assign participant id as first column of your harmonized dataframes
```{r, echo=FALSE}
#bio_GLOBE0 <- data.frame(id = GLOBE_table$id)
```
