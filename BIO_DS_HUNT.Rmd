...
# HUNT3
opal.assign.table.tibble(erasmus_opal, 'HUNT3', 'HUNT.HUNT3',variables = list('SemicroCRP_NT3BLM','SeTSH','SeT4_NT3BLM','SeTrig','SeTSH_NT3BLM'))
...
**R script**:  
```{r, echo=TRUE}
bio_HUNT_2$bio_t4_2 <- summary(HUNT3$SeT4_NT3BLM)
```
### **Variable label**: Thyroxine  
...
**R script**:  
```{r, echo=TRUE}
bio_HUNT_2$bio_tg_2 <- HUNT2$SeTrig_NT3BLM
```
### **Variable label**: Triglycerides 
